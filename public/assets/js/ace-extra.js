...
ace.settings = {
	...
	main_container_fixed : function(main_container, inside , save) {
		...
		var footer_container = document.getElementById('footer-content-inner');
		if (inside) {
			...
			if (footer_container && !ace.hasClass(footer_container, 'container')) ace.addClass(footer_container, 'container');
			...
			if (footer_container) ace.removeClass(footer_container, 'container');
