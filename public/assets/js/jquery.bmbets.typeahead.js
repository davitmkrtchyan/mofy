...
!function($){
  ...
  * ================================= */
  ...
  , lookup: function (event) {
      ...
      if (this.options.minWidth > $(window).width()) return;

      if (!this.query || this.query.length < this.options.minLength) {
        return this.shown ? this.hide() : this
      }

      items = $.isFunction(this.source) ? this.source(this.query, $.proxy(this.processHtml, this)) : this.source

      return items ? this.processHtml(items) : this
    }

  , processHtml: function (src) {
      var that = this
  ...
  $.fn.bs_typeahead.defaults = {
    source: []
  , items: 8
  , menu: '<div class="typeahead search-results dropdown-menu"></div>'
  , item: '<li><a href="#"></a></li>'
  , minLength: 1
  , minWidth: 975
  }
