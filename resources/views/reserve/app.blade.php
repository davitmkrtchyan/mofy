...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/jqcloud.css') }}" />
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="{{ URL::asset('assets/css/ace.css" class="ace-main-stylesheet" id="main-ace-style') }}" />
    <link rel="stylesheet" href="{{ URL::asset('assets/css/ace-skins.css') }}" />
    <link rel="stylesheet" href="{{ URL::asset('assets/css/datepicker.css') }}" />

    <link href="{{ URL::asset('assets/css/Bookmaker.css@v1" rel="stylesheet') }}" />
