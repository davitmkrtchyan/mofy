            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content" style="height: 300px;">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/admin/advertisement/add" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="file" class="form-control" id="advertisementImg" name="advertisementImg" required>
                            </div>
                            <!--End description-->
                                ...
                                <tr>
                                    ...
                                    <td class="table-text">
                                        <div>
                                            ...
                                            <img src="{{URL::asset('assets/images/bm/admin-advertisement/'.$advertisement->imageName)}}" alt="{{$advertisement->imageName}}"
                                    ...
                                    <td>
                                        ...
                                        <form action="/admin/advertisement/delete/{{ $advertisement->id }}" method="POST" id="deleteAdvertisementForm">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
