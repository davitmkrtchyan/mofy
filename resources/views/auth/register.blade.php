...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login Page - MoreOddsForYou</title>
        ...
        <div class="row">
            ...
            <span class="block input-icon input-icon-right">
                ...
                <i class="ace-icon fa fa-unlock-alt"></i>
                                            ...
                                            <label class="block clearfix">
            <span class="block input-icon input-icon-right">
                <input class="form-control" data-val="true" data-val-equalto="The password and confirmation password do not match." data-val-equalto-other="*.Password" id="ConfirmPassword" name="ConfirmPassword" placeholder="Repeat password" type="password" />
                ...
                <a href="/">User Agreement</a>
                        ...
                        <div class="center">
                            <h4 class="white" id="id-company-text">Copyright MoreOddsForYou &copy; </h4>
                            <div class="space-4"></div>
                        </div>
